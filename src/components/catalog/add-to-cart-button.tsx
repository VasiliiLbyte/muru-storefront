  ...
  if (variant === "icon") {
    return (
      <button
        ...
        onClick={add}
        className={cn(
          "inline-flex size-11 items-center justify-center text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.05)] transition-colors hover:text-brand focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none",
          className,
        )}
      >

      ...
      {product.inStock ? (
        <div className="hidden gap-3 lg:flex lg:flex-row lg:flex-wrap">
          <Button
            ...
            variant="outline"
            size="lg"
            className="min-h-12 w-full px-6 text-body lg:h-6 lg:min-h-0 lg:w-auto lg:px-8 lg:text-[13px]"
          ...
          <Button
            type="button"
            size="lg"
            className="min-h-12 w-full bg-brand px-6 text-body text-text-inverse hover:bg-brand-hover lg:h-6 lg:min-h-0 lg:w-auto lg:px-8 lg:text-[13px]"
            onClick={() => {
              addItem(product.sku);
              showAddedToast({
                sku: product.sku,
